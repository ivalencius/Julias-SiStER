...
if PARAMS.YNElast==1
    ...
    if t==1 & pit==1
        ...
        include("SiStER_viscosity_stress_bisection.jl") # spits out sII_s consistent with viscosity
        sII_s=copy(sII);
...
if PARAMS.YNPlas==1 
    ...
    s_nodes_yield=findall(etas_new.>eta_plas_s);
...
etan=etan_new; #  DONT THINK I NEED TO COPY
etas=etas_new;
