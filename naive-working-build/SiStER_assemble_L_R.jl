...
function SiStER_assemble_L_R(dx,dy,etas,etan,rho,BC,PARAMS,srhs_xx,srhs_xy)


## Fill LHS & RHS Solution Matrices
...
# fill in FD matrix & right-hand side
    ...
    #for j=1:Nx
        ...
        if (
            ...
            (j==1) || (
                ...
                (i==IP) && (j==JP) && (BC.top[2]!=3)
                ) || (BC.top[2]==3 && i==2 && j > 2 && j < Ny)) #<--G.Ito ### ORIGINALL IT WAS BC.TOP ~= 3 ###
